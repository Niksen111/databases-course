...
INSERT INTO Card_Owner (Card_Owner_ID, First_Name, Last_Name, Discount, City_ID)
    VALUES (1, 'John', 'Doe', 0.2, 1);
INSERT INTO Card_Owner (Card_Owner_ID, First_Name, Last_Name, Discount, City_ID)
    VALUES (2, 'Jane', 'Smith', 0.1, 1);
INSERT INTO Card_Owner (Card_Owner_ID, First_Name, Last_Name, Discount, City_ID)
    VALUES (3, 'Bob', 'Johnson', 0.3, 1);
INSERT INTO Card_Owner (Card_Owner_ID, First_Name, Last_Name, Discount, City_ID)
    VALUES (4, 'Samantha', 'Lee', 0.15, 1);
INSERT INTO Card_Owner (Card_Owner_ID, First_Name, Last_Name, Discount, City_ID)
    VALUES (5, 'Michael', 'Nguyen', 0.25, 1);
INSERT INTO Card_Owner (Card_Owner_ID, First_Name, Last_Name, Discount, City_ID)
    VALUES (6, 'Emily', 'Wang', 0.2, 2);
INSERT INTO Card_Owner (Card_Owner_ID, First_Name, Last_Name, Discount, City_ID)
    VALUES (7, 'David', 'Kim', 0.1, 2);
INSERT INTO Card_Owner (Card_Owner_ID, First_Name, Last_Name, Discount, City_ID)
    VALUES (8, 'Jessica', 'Garcia', 0.3, 2);
INSERT INTO Card_Owner (Card_Owner_ID, First_Name, Last_Name, Discount, City_ID)
    VALUES (9, 'Kevin', 'Chen', 0.15, 3);
INSERT INTO Card_Owner (Card_Owner_ID, First_Name, Last_Name, Discount, City_ID)
    VALUES (10, 'Sarah', 'Park', 0.25, 3);
