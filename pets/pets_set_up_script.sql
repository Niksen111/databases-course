...
CREATE TABLE Order1(
    ...
    Pet_ID                        INTEGER         NOT NULL,
    Employee_ID                   INTEGER         NOT NULL,
    Time_Order                    TIMESTAMP      DEFAULT current_timestamp    NOT NULL,
...
INSERT INTO Vaccination_Type(Vaccination_Type_ID, Name) VALUES (1, 'Биовак');
INSERT INTO Vaccination_Type(Vaccination_Type_ID, Name) VALUES (2, 'Рабикан');
INSERT INTO Vaccination_Type(Vaccination_Type_ID, Name) VALUES (3, 'Нобивак Piro');
INSERT INTO Vaccination(Vaccination_ID, Vaccination_Type_ID, Pet_ID) VALUES
       (1, 1, 3);
INSERT INTO Vaccination(Vaccination_ID, Vaccination_Type_ID, Pet_ID) VALUES
       (2, 2, 6);
INSERT INTO Vaccination(Vaccination_ID, Vaccination_Type_ID, Pet_ID) VALUES
...
SELECT * FROM Vaccination_Type JOIN Vaccination V on Vaccination_Type.Vaccination_Type_ID = V.Vaccination_Type_ID;
